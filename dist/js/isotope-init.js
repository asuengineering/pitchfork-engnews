...
document.addEventListener('DOMContentLoaded', function () {
  ...
  function initContainer(container) {
    ...
    function doLayout() {
      try {
        ...
        console.warn('isotope layout error', e);
      }
    ...
    var selects = Array.prototype.slice.call(blockRoot.querySelectorAll('select.filter'));
    if (!selects.length) {
      selects = Array.prototype.slice.call(document.querySelectorAll('select.filter'));
    }

    // capture each select's initial default value (so we can restore it later)
    var defaultValues = selects.map(function (s) {
      return s.value;
    });
  ...
  function initAll() {
    ...
    var containers = Array.prototype.slice.call(document.querySelectorAll('.news-feed'));
...
/******/ })()
;
//# sourceMappingURL=isotope-init.js.map